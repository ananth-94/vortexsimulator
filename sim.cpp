...
const int 	nv = 2000, npin_desired = 20000, numb_trig = 40;
const double 	R = 10, k = 1.0, phi = 0.1, V_1 = 2000, V_2 = 2000, trig_duration = 1, decel = -0.25e-3,
...
double N_ext = N_ext_0, omega_c = omega_0, omega_s = omega_0, del_t = 5e-3;
