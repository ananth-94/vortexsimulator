...
class MyScene(Scene):
	def construct(self):
		Title = "Progression of a glitch in a star with 10000 vortices, k = 0.4, and Xi = 0.5 * a"
		Subtitle = "20250618/set2/run1 - 418.5 to 421.5"

		nv = 10000 # Number of vortices
		...
		t_start = 418.5 # Start time of the glitch/feature of interest
		t_end = 421.5 # End time of the glitch/feature of interest

		# Reading the complete output data obtained from the simulation (sim_vortex_pos.dat or sim_vortex_pos_minimal.dat)
		data = pd.read_csv(r'~/temp/current/runs/20250618/set2/run1/sim_vortex_pos_minimal.dat', delimiter='\t')
		omegacvst = pd.read_csv(r'~/temp/current/runs/20250618/set2/run1/sim_omega_c.dat', delimiter='\t')
