...
class MyScene(Scene):
	def construct(self):
		...
		data = pd.read_csv(r'~/temp/current/runs/20250623/set1/run1/sim_vortex_pos_minimal.dat', delimiter='\t')
		omegacvst = pd.read_csv(r'~/temp/current/runs/20250623/set1/run1/sim_omega_c.dat', delimiter='\t')
