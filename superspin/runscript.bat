...
g++ -c ./codes/integration.cpp -Ofast -o ./compiles/integration.o -I D:\C++\Libraries\boost_1_88_0 -fopenmp
...
g++ ./compiles/main.o ./compiles/initialization.o ./compiles/utility.o ./compiles/integration.o ./compiles/support.o ./compiles/writes.o ./compiles/pinning.o ./compiles/triggers.o ./compiles/glitchfinder.o -Ofast -o ./compiles/program.exe -fopenmp
.\compiles\program.exe
