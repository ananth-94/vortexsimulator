...
class node
{
	...
	public:
		...
		{	
			...
			{
				double forcex = - k * (total_mass * dy) / (dist * dist); //DEBUG -- k was missing here! -- leads to exodus of vortices
				double forcey =  k * (total_mass * dx) / (dist * dist); //DEBUG -- k was missing here! -- leads to exodus of vortices
