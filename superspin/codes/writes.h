...
void write_data_post_dynamics(std::vector<double> &t_vector, std::vector<std::vector<double>> &f_vector, std::vector<double> &omega_c_vector, std::vector<double> &omega_s_vector,
	std::vector<int> &number_off_vector, std::vector<int> &sector_id_vector, std::vector<double> &trigger_times, std::vector<int> &out_vector, std::vector<int> &unpinned_vector);
